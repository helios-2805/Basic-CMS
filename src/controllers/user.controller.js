...
const refreshAccessToken = asyncHandler(async (req, res) => {
  ...
  // now checking the incomingrefreshtoken(from the user) and the token we saved in the db which we got by decoding the incoming one\
  // if both are same then provide the access else decline the access
    ...
    // meaning that the user is authenticated and is provided with new refresh token
